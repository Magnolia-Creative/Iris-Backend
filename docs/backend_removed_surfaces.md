...
- Canonical replacement: `POST /agent/intent`, or a future canonical agent streaming route if
...
- Canonical replacement: `POST /agent/intent` returning the canonical `ui` plan from
  `app.agent.intent.ui`.
